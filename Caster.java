...
public class Caster {
    ...
    private void paintPlayers(Spieler sp) {
        ...
        try {
            ...
            while (ergebnis.next()) {
                ...
                Sprite af = new Sprite(ergebnis.getDouble(2), ergebnis.getDouble(3), ergebnis.getString(1),
                        ergebnis.getDouble(4), ergebnis.getInt(5), true, texManager.getSpriteTexture(8),
                        texManager.getSpriteTexture(7), texManager.getSpriteTexture(6), texManager.getSpriteTexture(5),
                        texManager.getSpriteTexture(4), texManager.getSpriteTexture(3), texManager.getSpriteTexture(2),
                        texManager.getSpriteTexture(1));
                sprites.add(af);
            }
            ergebnis.close();
            st.close();
    ...
    private void floorCasting(Graphics g, Karte k) {
        ...
        // int[] rgbRaster = ((DataBufferInt)
        // floorImage.getRaster().getDataBuffer()).getData();
        ...
        g.drawImage(floorImage, 0, screenHeight / 2, screenWidth, screenHeight, 0, 0, SWFL, SHFL, null);
    }
    ...
    public void updategame() {
        ...
        run = true;
        Sprite test = new Sprite(15, 15, "Barrel", 0, -1, true, texManager.getSpriteTexture(16),
                texManager.getSpriteTexture(15), texManager.getSpriteTexture(14), texManager.getSpriteTexture(13),
                texManager.getSpriteTexture(12), texManager.getSpriteTexture(11), texManager.getSpriteTexture(10),
                texManager.getSpriteTexture(9));
        sprites.add(test);
        Sprite directional = new Sprite(14, 11, "Player", 0, -1, true, texManager.getSpriteTexture(8),
                texManager.getSpriteTexture(7), texManager.getSpriteTexture(6), texManager.getSpriteTexture(5),
                texManager.getSpriteTexture(4), texManager.getSpriteTexture(3), texManager.getSpriteTexture(2),
                texManager.getSpriteTexture(1));
